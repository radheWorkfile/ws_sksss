    ...
    e.fn.prettyPhoto = function(s) {
        ...
        e.prettyPhoto.open = function(t) { if (typeof settings == "undefined") { settings = s;
            ...
            u = false; if (movie_height.indexOf("%") != -1) { movie_height = parseFloat(e(window).height() * parseFloat(movie_height) / 100 - 150);
                ...
                u = true }
            $pp_pic_holder.fadeIn(function() { settings.show_title && pp_titles[set_position] != "" && typeof pp_titles[set_position] != "undefined" ? $ppt.html(unescape(pp_titles[set_position])) : $ppt.html("Â ");
                imgPreloader = "";
                skipInjection = false; switch (S(pp_images[set_position])) {
                    ...
                    case "youtube":
                        ...
                        movie_id = i("v", pp_images[set_position]); if (movie_id == "") { movie_id = pp_images[set_position].split("youtu.be/index.html");
