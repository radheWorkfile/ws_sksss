...
<head>
    ...
    <style>
        ...
        .natAcoMan{border:2px solid #e7ebef;margin-top:0.5rem; border-radius: 1rem;margin-bottom:1rem;}
        .natAccNamSecMan{width:45%;display:inline-block;padding-left:6rem;}
        ...
        <div id="fh5co-contact">
            <div class="container wow fadeInDown" style="margin-top: 20px;" data-wow-duration="1000ms" data-wow-delay="600ms">
                <div class="center wow fadeInDown">
                    <h5 class="contact-main">Support Us</h5>
                </div>
        ...
        <div class="container">
            ...
            <form id="addDonate" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6" id="accInfo">
                        <label for="subject">Donor Info</label>
                    ...
                    <div class="col-md-12" id="nationalAcc" style="display:none;"><br>
                      <div class="row">
                        <div class="col-md-2"></div>
                        <div class="col-md-8 natAcoMan">  
                        <h3 style="text-align:center;font-weight:600;color:#0db7e6;"><span>Account Info<hr></span></h3>
                          <div class="natAccNamSecMan"> 
                    ...
                    <div class="col-md-12" id="interNaAcc" style="display:none;"><br>
                      <div class="row">
                        <div class="col-md-2"></div>
                        <div class="col-md-8 natAcoMan">
                        <h3 style="text-align:center;font-weight:600;color:#0db7e6;"><span>Account Info<hr></span></h3>
                    ...
                    <div class="col-md-12" id="swiftSec" style="display:none;">
                    ...
                    <div class="col-md-12" id="remarkSec" style="display:none;"><br>
                        ...
                        <textarea name="remark" id="remark" cols="30" rows="4" class="form-control plaHolMan"  placeholder="Enter Your Message "></textarea>
                    </div>
...
<script>
    $(document).ready(function() {
                $("#accInfo").change(function() {
                var accSecMan = $('#acc_info').val();
                if (accSecMan == '1') {
                    $("#nationalAcc,#swiftSec,#remarkSec").show();
                    $("#interNaAcc").hide();
                } else if (accSecMan == '2') {
                    $("#interNaAcc,#swiftSec,#remarkSec").show();
                    $("#nationalAcc").hide();
                }
                 else {
                    $(".othDetInp").hide();
