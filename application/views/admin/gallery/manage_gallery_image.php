...
<body class="hold-transition sidebar-mini layout-fixed ">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    <a href="javascript:void(0);" data-toggle="modal" data-target="#add_gallery_modal" title='Click Add gallery' class="btn btn-primary float-right"> <i class="fas fa-plus"></i> Add Gallery Image</a><br><br>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        $status = ($gall['status'] == 1) ?
                                            "<a style='color:green' href='javascript:void()' onClick='return changeStatus(\"" . $gall['id'] . "\",\"0\",\"gallery\",\"admin/common/chageStatus\")' title='Click to Di-Active News'><b><i class='fa fa-check'></i> </b></a>"
                                            :
                                            "<a style='color:red'  href='javascript:void()'  onClick='return changeStatus(\"" . $gall['id'] . "\",\"1\",\"gallery\",\"admin/common/chageStatus\")' title='Click to Active News'><b><i class='fa fa-times'></i> </b></a>";
                                        echo $status;
                                        ?>&nbsp;
        ...
        <div class="modal fade" id="add_gallery_modal">
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    ...
                    <form id="add_gallery" method="post" accept-charset="utf-8" enctype="multipart/form-data">
    ...
    <script>
        $('#add_gallery').submit(function(e) {
            e.preventDefault();
            $.ajax({
                url: '<?= base_url() ?>admin/gallery/save_data',
                type: "POST",
        ...
        function view(id) {
            $.ajax({
                type: 'POST',
                url: '<?= base_url() ?>' + 'admin/gallery/view_gallery',
                data: {
                    'id': id,
                },
                success: function(data) {
        ...
        function deletedata(id) {
            if (confirm("Do You Want To Delete This Image ?")) {
                $.ajax({
                    type: 'POST',
                    url: '<?= base_url() ?>' + 'admin/gallery/delete_gallery',
                    data: {
                        'id': id,
                    },
                    success: function(data) {
